        ...
        <div className="container">
          ...
          <div className="services-row">
            <ServicesCard
              ...
              alt="Habitaciones en Copahue"
            />
            <ServicesCard
              title="Entretenimiento"
              description="Hotel Valle del Volcán ofrece diversas actividades para su entretenimiento en Copahue."
              image="/assets/images/entretenimiento-hotel-valle-del-volcan.jpg"
              alt="Entretenimiento en Copahue"
            />
            <ServicesCard
            ...
            <ServicesCard
              ...
              alt="Restaurante Hotel Valle del Volcán en Copahue"
            />
          </div>
          <div
